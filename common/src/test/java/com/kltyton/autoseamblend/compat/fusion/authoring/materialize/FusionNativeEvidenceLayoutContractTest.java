...
class FusionNativeEvidenceLayoutContractTest {
    ...
    static void bootstrapRegistries() {
        // 中文：1.21.1 Fusion 构造 MutableQuad 时会初始化 RenderType/Blocks；独立
        // JVM 测试必须先提供游戏版本并引导原版注册表。
        // English: Fusion 1.21.1 initializes RenderType/Blocks while constructing
        // MutableQuad, so the standalone JVM test must provide a game version and
        // bootstrap vanilla registries first.

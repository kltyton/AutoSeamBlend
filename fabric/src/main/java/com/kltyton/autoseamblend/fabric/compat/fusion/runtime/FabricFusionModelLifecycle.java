...
public final class FabricFusionModelLifecycle {
    ...
    public static BakedModel wrap(
        ...
        // ("pk is null").
        // 1.20.1 AfterBake.Context.id() returns the plain model id (ResourceLocation).
        ResourceLocation topLevelId =
                context.id();
        if (topLevelId == null) {
            return model;
        }

...
import com.kltyton.autoseamblend.fabric.frontend.uilib.render.preview.FabricBlockScenePictureInPictureRenderer;
...
public final class FabricClientLifecycle {
    ...
    public static void register(
        ...
        FabricBlockScenePictureInPictureRenderer.register();

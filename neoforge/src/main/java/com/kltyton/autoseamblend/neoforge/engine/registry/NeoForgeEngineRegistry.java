...
public final class NeoForgeEngineRegistry {
    private static final EngineDefinitionCatalog DEFINITIONS = EngineDefinitionCatalog.of(List.of(
            EngineDefinition.of(
                    ...
                    "mcpatcher",
                    "3.0.0+0.0.1+1.21.1.neoforge",
                    "NeoContinuity 3.0.0+0.0.1+1.21.1.neoforge accepted properties and processor lifecycle",
            ...
            EngineDefinition.of(
                    ...
                    "ctm_mod",
                    "1.21-1.2.1+3",
                    "CTM Mod 1.21-1.2.1+3 public model, connection-check, and strategy APIs",
            ...
            EngineDefinition.of(
                    ...
                    "athena",
                    "4.0.6",
                    "Athena 4.0.6 public model, CtmState, and provider APIs",

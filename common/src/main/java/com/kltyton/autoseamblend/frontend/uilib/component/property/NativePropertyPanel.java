...
public final class NativePropertyPanel {
    ...
    private final EditBoxWidget entryIdInput =
            new EditBoxWidget(
                    Minecraft.getInstance().font,
                    0,
                    0,
    ...
    private ScrollContainerWidget propertyScroll;
    private ScrollContainerWidget pickerScroll;
    private ScrollContainerWidget editorScroll;
    private double propertyScrollAmount;
    private double pickerScrollAmount;
    private double editorScrollAmount;
    ...
    public void open(
        ...
        pickerScroll = null;
        editorScroll = null;
        propertyScrollAmount = 0.0D;
        pickerScrollAmount = 0.0D;
        editorScrollAmount = 0.0D;
    }
    ...
    private int layoutSelectorEntries(
        ...
        for (int index = 0;
            ...
            chip.active = propertyEditingAllowed
                    && entry.editable()
                    && host.actionsEnabled();
            canvas.addWidget(chip);
            ...
            canvas.placeButton(
                    ...
                    controlY,
                    30);
            down.active = entryActionsAllowed
                    && index
                            < selector.entries()
                                            .size()
                                    - 1
            ...
            canvas.placeButton(
                    ...
                    controlY,
                    56);
            remove.active = entryActionsAllowed
                    && host.actionsEnabled();
            remove.setAction(() ->
    ...
    private void rememberActiveScroll() {
        if (propertyScroll != null) {
            propertyScrollAmount =
                    propertyScroll.scrollAmount();
        }
        if (pickerScroll != null) {
            pickerScrollAmount =
                    pickerScroll.scrollAmount();
        }

...
import com.kltyton.autoseamblend.fabric.frontend.uilib.screen.FabricPreviewWorkspaceRenderer;
 ...
 */
public final class FabricWorkbenchController {
    private final FabricWorkbenchNativePort nativePort;
    ...
    private FabricWorkbenchController(
            Minecraft minecraft,
            EngineQuerySelection selection) {
        nativePort = new FabricWorkbenchNativePort(
                minecraft,
                selection.family(),
                selection.engineId());
        ...
        screen = new UilibWorkbenchScreen<>(
                session,
                new FabricPreviewWorkspaceRenderer<>(
    ...
    public static int open() {
        ...
        FabricWorkbenchController controller =
                new FabricWorkbenchController(minecraft, selection.orElseThrow());
    ...
    private static UilibWorkbenchScreen<ManagedAuthoringDraft> blockedScreen(
        ...
        return new UilibWorkbenchScreen<>(
                session,
                new FabricPreviewWorkspaceRenderer<>(ignored -> Optional.empty(), () -> {}),

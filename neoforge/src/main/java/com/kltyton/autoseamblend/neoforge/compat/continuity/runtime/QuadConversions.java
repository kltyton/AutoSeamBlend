...
/**
 * 中文：1.21.1 NeoContinuity/FRAPI 的共享 Quad 转换与缺失精灵判定；26.1 的
 * MutableQuad.setFrom 与 RenderUtil.isMissingSprite 在 1.21.1 中不存在。
 *
 * English: Shared quad conversion and missing-sprite detection for the 1.21.1
 * NeoContinuity/FRAPI surface; 26.1's MutableQuad.setFrom and
 * RenderUtil.isMissingSprite do not exist in 1.21.1.
 */

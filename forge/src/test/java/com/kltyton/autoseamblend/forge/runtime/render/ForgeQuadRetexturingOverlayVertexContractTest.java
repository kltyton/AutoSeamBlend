 ...
 */
class ForgeQuadRetexturingOverlayVertexContractTest {
    ...
    void overlayWritesFaceNormalsOnAllVertices() {
        ...
        int normalOffset = 7 /* NORMAL int offset in DefaultVertexFormat.BLOCK */;

        for (Direction face : Direction.values()) {
            BakedQuad quad = ForgeQuadRetexturing.overlay(
                    face,
                    sprite,
                    0xFFFFFFFF);

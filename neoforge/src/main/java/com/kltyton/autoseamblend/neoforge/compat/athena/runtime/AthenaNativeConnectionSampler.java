...
final class AthenaNativeConnectionSampler {
    ...
    static CtmState stateInTextureSpace(
            ...
            ConnectionRuleSet<Block> rules) {
        // 中文：Athena 4.0.6 的字段顺序本身正确；这里只把面规范方向旋转/镜像到实际 Quad 的纹理空间。
        // English: Athena 4.0.6's field order is already correct; only rotate/mirror the face-canonical state into the actual quad texture space.

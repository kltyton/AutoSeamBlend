...
public final class InitialBlockAtlasResources {
    ...
    // 中文：1.21.1 的 SpriteSourceList.load 使用 FileToIdConverter("atlases", ".json")
    ...
    // English: In 1.21.1 SpriteSourceList.load maps the atlas INFO id ("minecraft:blocks")
    ...
    private static final class CaptureOutput
        ...
        private static SourceRead resolveDerived(
            ...
            Objects.requireNonNull(loader, "loader");
            Objects.requireNonNull(budget, "budget");
            try (SpriteContents contents = loader.apply(

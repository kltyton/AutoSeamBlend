...
public final class FusionPreparedTextureSupport {
    ...
    public static PreparedBase prepareBase(
        ...
        QuadProcessor<?> processor = texture.initializeModelQuad(
    ...
    private static BaseTextureData.RenderType renderType(SpriteTransparency transparency) {
    ...
    public static QuadProcessor<Object> castProcessor(
            QuadProcessor<?> processor) {
        Objects.requireNonNull(processor, "processor");
        return (QuadProcessor<Object>) processor;
    }

...
/**
 * 中文：为一次显式 Managed 保存准备的不可变原生格式文档。
 *
 * English: One immutable native-format document prepared for an explicit Managed save.
 *
 * @param relativePath 中文：Managed 包内相对路径。 / English: Relative path inside the Managed pack.
 * @param content 中文：原生格式文档字节。 / English: Native-format document bytes.
 */

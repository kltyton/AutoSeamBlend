package com.kltyton.autoseamblend.forge.compat.continuity.runtime.culling;
 ...
 *
 * <p>中文：1.20.1 Forge Continuity/Constancy 的 CtmBakedModel 走 Fabric Renderer API 的
 * emitBlockQuads 路径（isVanillaAdapter=false），因此除 getQuads 重分桶外，还必须在
 * QuadTransform 中把未剔除的 UP/DOWN 端盖 Quad 改写为对应方向的 cullFace。
 *
 * <p>English: On 1.20.1 Forge Continuity/Constancy, CtmBakedModel renders through the Fabric Renderer

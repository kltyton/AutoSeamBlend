...
public final class GeneratedTileMaterializer {
    ...
    private static int[] materializeStraightArgb(
            ...
            OverlayCutoutProfile overlayProfile) {
        ArgbImage generated;
        if (recipe instanceof GeneratedTileRecipe.Source) {
            generated = source;
        } else if (recipe instanceof GeneratedTileRecipe.BorderConnections connections) {
            generated = Ctm47TileGenerator.generate(
                    source,
                    connections.connections(),
                    borderWidth(
                            source.width(),
                            source.height()));
        } else if (recipe instanceof GeneratedTileRecipe.CompactConnections connections) {
            generated = compact(
                    source,
                    connections.connections());
        } else if (recipe instanceof GeneratedTileRecipe.BlendConnections connections) {
            generated = overlayConnections(
                    source,
                    connections.connections(),
                    overlayProfile);
        } else if (recipe instanceof GeneratedTileRecipe.OverlayMask17 mask) {
            generated = overlay(
                    source,
                    mask.slot(),
                    overlayProfile);
            ...
            throw new IllegalArgumentException(
                    "unsupported generated tile recipe " + recipe.getClass().getName());
        }

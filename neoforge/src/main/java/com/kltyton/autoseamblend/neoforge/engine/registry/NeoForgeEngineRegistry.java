package com.kltyton.autoseamblend.neoforge.engine.registry;
...
/**
 * 中文：NeoForge 只保留 Loader 发现与原生能力 provider 桥，Discover→Validate→Select 状态机与
 * 稳定排序由 common 统一执行。
 *
 * English: NeoForge keeps only loader discovery and native capability-provider bridges. The
 * common module owns the Discover-Validate-Select state machine and stable ordering.
 */
public final class NeoForgeEngineRegistry {
    private static final EngineDefinitionCatalog DEFINITIONS = EngineDefinitionCatalog.of(List.of(
            EngineDefinition.of(
                    ...
                    "mcpatcher",
                    "3.0.1-0.0.8",
                    "NeoContinuity 3.0.1-0.0.8 accepted properties and processor lifecycle",
            ...
            EngineDefinition.of(
                    ...
                    "ctm_mod",
                    "26.1.2.2",
                    "CTM Mod 26.1.2.2 public model, geometry-key, and strategy APIs",
                    "io/github/chiselteam/ctm/client/AbstractConnectedTextureBlockStateModel.class",
                    "io/github/chiselteam/ctm/client/baked/StandardCTMBlockStateModel.class",
                    "io/github/chiselteam/ctm/api/geometry/StandardCTMKey.class"),
            EngineDefinition.of(
                    "fusion",
                    EngineFamily.FUSION,
                    "fusion",
            ...
            EngineDefinition.of(
                    ...
                    "athena",
                    "4.7.3",
                    "Athena 4.7.3 public model, CtmState, and provider APIs",
                    "earth/terrarium/athena/api/client/neoforge/AthenaBakedModel.class",
     ...
     */
    /**
     * 中文：NeoForge provider 只负责原生能力证明和适配器构造；版本、链接门、状态与诊断聚合由
     * common builder 处理。
     * English: The NeoForge provider only proves native capabilities and constructs adapters;

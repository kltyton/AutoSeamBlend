package com.kltyton.autoseamblend.neoforge.frontend.uilib.screen;
...
import com.kltyton.autoseamblend.neoforge.frontend.uilib.render.preview.NeoForgeBlockScenePorts;
 ...
 * English: Sole Loader renderer factory for the accepted NeoForge
 * InteractiveBlock/PIP preview.
 */
public final class NeoForgePreviewWorkspaceRenderer<T extends WorkbenchDraftFields>
    ...
    public NeoForgePreviewWorkspaceRenderer(
    ...
    public void assemble(
        ...
        layout = new PreviewWorkspaceLayout(
                host,
                NeoForgeBlockScenePorts.geometryCache(),
                NeoForgeBlockScenePorts::submit);
        layout.assemble(
                scene.orElseThrow(),
                view.preview()

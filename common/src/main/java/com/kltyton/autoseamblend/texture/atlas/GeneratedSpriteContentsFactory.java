    ...
    public static SpriteContents create(
        ...
        try {
            ...
            ResourceMetadata metadata = new ResourceMetadata() {
                ...
                public <T> java.util.Optional<T> getSection(
                    ...
                    if (serializer == AnimationMetadataSection.SERIALIZER) {
                        return (java.util.Optional<T>) animation;
                    }
                    if (serializer == TextureMetadataSection.SERIALIZER) {
                        return (java.util.Optional<T>) texture;
                    }

...
/**
 * 中文：提供所有可选引擎插件共用的生命周期和选择逻辑；子类可记录配置包名。
 * English: Shared lifecycle and selection logic for optional-engine plugins;
 * subclasses may record the mixin config package.
 */

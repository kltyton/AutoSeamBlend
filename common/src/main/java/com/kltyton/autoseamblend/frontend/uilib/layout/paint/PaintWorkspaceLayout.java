...
public final class PaintWorkspaceLayout<T extends WorkbenchDraftFields> {
    ...
    private final TextBoxComponent colorInput =
            textBox("gui.autoseamblend.paint.color");

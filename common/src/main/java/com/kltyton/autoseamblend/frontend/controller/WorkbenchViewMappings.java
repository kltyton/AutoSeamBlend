...
public final class WorkbenchViewMappings {
     ...
     *
     * English: Projects an immutable paint view from the real paint document; editable,
     * undo, and redo state derive from the real slot evidence and history stacks.
     */

...
/**
 * 中文：MC 1.21.1 没有 26.1 的 com.mojang.blaze3d.platform.Transparency；这里从精灵原始像素
 * 推导等价的三态透明度，供渲染层与 CUTOUT/TRANSLUCENT 选择使用。
 *
 * English: MC 1.21.1 lacks 26.1's com.mojang.blaze3d.platform.Transparency; this derives the

...
2. Install **Fzzy Config** (required) and **any one** of these engines:
    ...
    - [Continuity](https://www.curseforge.com/minecraft/mc-mods/continuity) / [NeoContinuity](https://www.curseforge.com/minecraft/mc-mods/neocontinuity)
   ...
   Fabric targets have no CTM adapter). On some loaders, Fabric API and
   Fabric Language Kotlin are also required. The UI library (UILib) is
   bundled with the mod — nothing else to install.

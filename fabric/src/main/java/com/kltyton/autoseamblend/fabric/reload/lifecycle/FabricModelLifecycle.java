...
public final class FabricModelLifecycle {
    ...
    /**
     * 中文：1.21.1 AfterBake Context 没有 state()，从 topLevelId 的 variant 解析 BlockState。
     *
     * English: The 1.21.1 AfterBake Context has no state(); resolve the
     * BlockState from the topLevelId variant.
     */
    public static BlockState resolveState(
        ...
        // 模型（物品、builtin/entity、特殊模型等），此时 topLevelId() 合法为 null；显式
        ...
        // (items, builtin/entity, special models) whose topLevelId() is legitimately

...
/**
 * 中文：Fabric 适配器只负责把 BakedQuad/BlockStateModel 转成 common 表面探针。
 *
 * English: The Fabric adapter only converts BakedQuad/BlockStateModel data into
 * the common surface-probe contract.
 */
public enum FabricFusionNativeQueryOwnership
    ...
    synchronized void beginModelCapture(
            long generation) {
    ...
    synchronized void captureModel(
            BlockState state,
    ...
    synchronized void abortModelCapture(
            long generation) {

...
public final class NativeExportRuntime {
    ...
    public static ManagedExportIr assemble(
        ...
        long surfaceGeneration = drafts.getFirst().surfaceGeneration();
    ...
    /** 中文：导出 IR 的 Loader/version 元数据；不包含 Loader 类型。 / English: Loader/version metadata for export IR without Loader types. */

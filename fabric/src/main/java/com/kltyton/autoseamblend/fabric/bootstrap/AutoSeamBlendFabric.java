...
/**
 * 中文：1.21.1 Fabric 客户端 composition root。
 *
 * <p>English: 1.21.1 Fabric client composition root. Fabric has no CTM Mod
...
public final class AutoSeamBlendFabric implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        if (engines.engineRequired()) {
            Constants.LOG.error(
                    "ENGINE_REQUIRED: install Continuity, Fusion, or Athena for Fabric 1.21.1");
        }
    }
}

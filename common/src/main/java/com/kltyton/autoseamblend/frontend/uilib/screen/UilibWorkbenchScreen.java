 ...
 */
    ...
    @Override
    public void onTickScreen(
            GuiGraphics guiGraphics,
            int mouseX,
            int mouseY,
            float delta) {
        // 中文：工作台逐帧绘制挂点；渲染由各 UILib 组件 render 完成。
        // English: Per-frame screen render hook; UILib components draw themselves.
    }
    ...
    protected boolean previewMouseClicked(
            ...
            double mouseY,
            int button) {
        return previewRenderer.mouseClicked(
                mouseX,
                mouseY,
                button);
    }
    ...
    protected boolean previewMouseReleased(
            ...
            double mouseY,
            int button) {
        return previewRenderer.mouseReleased(
                mouseX,
                mouseY,
                button);
    }

package com.kltyton.autoseamblend.forge.compat.ctm_mod.bootstrap;
...
import com.kltyton.autoseamblend.forge.compat.ctm_mod.runtime.CtmModPreviewProvider;
import com.kltyton.autoseamblend.forge.compat.ctm_mod.runtime.CtmModModelLifecycle;
import com.kltyton.autoseamblend.forge.compat.ctm_mod.runtime.CtmModNativeModelOwnershipProvider;
...
public final class CtmModRuntimeBootstrap {
    ...
    public static void register(IEventBus modEventBus) {
        // 中文：Forge 方块外观是 Loader 专属 API，作为钩子注入公共 CTM overlay 采样。
        // English: Forge block appearance is a Loader-exclusive API and joins

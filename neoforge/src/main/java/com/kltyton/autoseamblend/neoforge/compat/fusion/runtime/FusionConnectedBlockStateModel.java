...
final class FusionConnectedBlockStateModel
    ...
    /**
     * 中文：1.21.1 的 BakedQuad 不保留 Fusion MutableQuad.renderTypes；可能生成
     * overlay 的模型必须额外广告 CUTOUT pass，防止透明遮罩在 SOLID/CUTOUT_MIPPED
     * 原模型 pass 中被当作不透明像素绘制为黑色。
     *
     * <p>English: A 1.21.1 BakedQuad does not retain Fusion MutableQuad.renderTypes.
    ...
    /**
     * 中文：Fusion 1.21.1 MutableQuad 没有颜色 ABI，overlay ARGB 在发射后写入顶点色。
     *
     * English: Fusion 1.21.1 MutableQuad has no color ABI, so the overlay ARGB

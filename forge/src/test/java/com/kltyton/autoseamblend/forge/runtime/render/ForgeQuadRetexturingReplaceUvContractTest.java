...
/**
 * 中文：ForgeQuadRetexturing.replace 的 UV 合同回归测试。source 与 target 精灵放在
 ...
 *
 * <p>English: UV contract regression test for ForgeQuadRetexturing.replace. The source
 ...
 * pixels.
 */
class ForgeQuadRetexturingReplaceUvContractTest {
    ...
    private static final int UV0_OFFSET =
            4 /* UV0 int offset in DefaultVertexFormat.BLOCK */;
    private static final int COLOR_OFFSET =
            3 /* COLOR int offset in DefaultVertexFormat.BLOCK */;
    ...
    void replaceRemapsUvIntoTargetBoundsPreservingNormalizedCorners() {
        ...
        BakedQuad replaced = ForgeQuadRetexturing.replace(

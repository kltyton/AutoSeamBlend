 ...
 * common 的 FusionModifierDocumentLocation.resourceId(ResourceLocation) 提供。当前共享类尚不
 ...
 * FusionModifierDocumentLocation.resourceId(ResourceLocation). The shared class does not exist
...
class FusionAcceptedDocumentLocationContractTest {
    ...
    private static final ResourceLocation STRIPPED_MODEL_ID =
            new ResourceLocation("minecraft:block/glass");
    private static final ResourceLocation FULL_FILE_ID =
